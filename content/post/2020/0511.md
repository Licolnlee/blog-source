...
![sshot-1.png](https://i.loli.net/2020/05/12/r6V3ThBs4mOUPMf.png)
...
![sshot-2.png](https://i.loli.net/2020/05/12/UeSBZ58kutxOWyn.png)
然后前往自己的注册邮箱确认注册信息。

### 创建代码库

登录之后，点击页面右上角的加号，选择 `New repository`。
![sshot-3.png](https://i.loli.net/2020/05/12/sBWm1J75ejEapH8.png)
在 `Repository name` 下填写 `[Your Username].github.io`。
![sshot-4.png](https://i.loli.net/2020/05/12/47YuRIzNJD3Znoh.png)
...
#### 比较
![sshot-5.png](https://i.loli.net/2020/05/12/YVeAIXBUb8O5a2G.png)
...
#### 安装
![sshot-6.png](https://i.loli.net/2020/05/12/TDICsoXM65JrxyP.png)
...
#### 安装主题
![sshot-7.png](https://i.loli.net/2020/05/12/aj2phXLkuZBI6KH.png)
